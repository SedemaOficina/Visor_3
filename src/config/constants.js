// Inicializar namespace de forma segura (sin sobrescribir)
window.App = window.App || {};
window.App.Constants = window.App.Constants || {};

// Definir constantes usando Object.assign para permitir extensiones
Object.assign(window.App.Constants, {
    COLORS: {
    ...
    INITIAL_CENTER: [19.34, -99.145], // Centro CDMX aprox
    INITIAL_ZOOM: 10,
    FOCUS_ZOOM: 16
});
console.log('✅ Configuration loaded (constants.js)');
